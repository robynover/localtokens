<items>
	...
	<ul>
		<li each={ items }>
		  { description }&nbsp;<a id="item_{id}" href="#" class="del" onclick={delete}><i class="fa fa-times" aria-hidden="true"></i></a>
		</li>
	</ul>
	...
	<script>
		...
		add(e) {
		  ...
		  if (this.refs.input.value.length > 0) {
		    //this.items.push({ description: this.refs.input.value });
		...
		delete(e){
			...
			//$(li).append('<p>Really delete? Yes No </p>');
			//var txtNode = document.createTextNode("Really delete?");
