<photo-upload>
	<p class="edit-photo"><i class="fa fa-pencil" aria-hidden="true" onclick={toggleForm}></i></p>

	<div id="user-photo-upload" show={formVisible}>
		<input type="file" name="profilephoto" id="user-photo-file" ref="photo"><br>
		<p>File must be less than 4MB</p>
		<button ref="button" onclick={upload}>Upload</button>
	</div>
