<editbox>
	...
	<p if={ isUser() } class="edit-profile">
		<a onclick = {toggle} href="#" >
			<i class="fa fa-pencil" aria-hidden="true"></i>
		</a>
	</p>

	<div id="editmodal" show={ show_modal }>
		<p class="modalclose">
			<a onclick = {toggle} href="#" class="close">
				<i class="fa fa-times-circle-o" aria-hidden="true"></i>
			</a>
		</p>
		<textarea name="message" ref="message">{opts.profile_text}</textarea>
